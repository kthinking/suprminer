...
extern int scanhash_x16r(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done,bool hex);
...
void x16r_hash(void *output, const void *input,bool hex);
